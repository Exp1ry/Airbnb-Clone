  ...
  return (
    <>
      <div className="block max-w-7xl mx-auto px-8">
        <h1 className="font-semibold pb-5 text-2xl sm:text-3xl md:text-4xl text-red-500 text-center">
        ...
        {data.map(({ img, title }: Data_2) => (
          <>
            <div className="p-3 " key={Math.random()}>
              ...
              ></img>
              <h1 className="  mt-4 font-semibold pb-5 text-base sm:text-lg md:text-xl lg:text-2xl text-red-400">
                {title}
              </h1>
            </div>
          </>
