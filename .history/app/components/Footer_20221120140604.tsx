...
const Footer = () => {
  return (
    <>
      <div className="w-full md:hidden bg-gray-400">
        <p>Copy right</p>
      </div>
      <div className="grid grid-cols-1 text-center md:grid-cols-5 mt-5 bg-gray-100 px-5 md:px-32 md:py-14 text-gray-600 gap-5 divide-y-2 md:divide-x-2 md:divide-y-0 ">
        <div className="hidden md:inline space-y-4 text-xs text-gray-800 ">
