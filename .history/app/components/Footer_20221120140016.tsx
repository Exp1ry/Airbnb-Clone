...
const Footer = () => {
  return (
    <div className="grid grid-cols-1 text-center md:grid-cols-5 mt-5 bg-gray-100 px-5 md:px-32 py-2 md:py-14 text-gray-600 gap-5 divide-y-2 md:divide-x-2 md:divide-y-0 ">
      ...
      <div className="space-y-4 text-xs text-gray-800 mt-4 grid grid-cols-6">
