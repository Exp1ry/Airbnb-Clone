...
const ThirdCard = ({ img, title, description, buttonText }: Props) => {
  return (
    <section className="py-16 px-7 sm:px-14 md:px-40 md:mx-auto">
      <div className="relative h-96 min-w-[300px] md:min-w-[600px] lg:max-w-[1200px] xl:max-w-[2000px] xl:h-[500px] mx-auto">
        <Image
          src={img}
          layout="fill"
          objectFit="cover"
