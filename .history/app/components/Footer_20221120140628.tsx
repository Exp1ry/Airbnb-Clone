...
const Footer = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-1 text-center md:grid-cols-5  bg-gray-100 px-5 md:px-32 md:py-14 text-gray-600 gap-5 divide-y-2 md:divide-x-2 md:divide-y-0 ">
