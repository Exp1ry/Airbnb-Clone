...
const Footer = () => {
  return (
    <div className="grid grid-cols-1 text-center md:grid-cols-5 mt-5 bg-gray-100 px-5 md:px-32 py-5 text-gray-600 gap-5 divide-y-2 md:divide-x-2 md:divide-y-0 ">
