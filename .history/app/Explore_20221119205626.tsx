    ...
    <>
      <div className="pt-6 max-w-7xl mx-auto px-8 sm:px-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4  ">
          {data.map((i: Data) => (
            <div className="text-center space-y-3 flex text-sm space-x-2 p-3 text-center hover:shadow-lg cursor-pointer">
              <img
                src={i.img}
                alt="img"
                className=" h-[3rem] md:h-[6rem] w-[3rem] h-p[rem] md:w-[6rem] lg:w-[6rem] rounded-xl "
              ></img>
              <div className="block">
                <p>{i.location}</p>
